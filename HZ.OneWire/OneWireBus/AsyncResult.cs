...
namespace HZ.OneWireBus
{
	...
	public class AsyncResult : IAsyncResult
	{
		...
		/// <summary>
		/// The device which this AsyncResult belongs to
		/// </summary>
		public readonly OneWireDevice Owner;
		...
		public AsyncResult(OneWireDevice owner, AsyncCallback asyncCallback = null, object asyncState = null)
		{
			if (owner == null)
			{
				throw new ArgumentNullException("owner", "The owner cannot be null");
			}
			...
			Owner.OneWireBus.AddAsyncTask(this);
		}
